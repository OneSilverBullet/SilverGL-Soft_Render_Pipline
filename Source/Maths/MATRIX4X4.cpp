...
MATRIX4X4 MATRIX4X4::TBN(const VECTOR3D & tangent, const VECTOR3D & bitangent, const VECTOR3D & normal)
{
	MATRIX4X4 tangentMat;
	tangentMat.entries[0] = tangent.x;
	//First 
	tangentMat.entries[0] = tangent.x;
	tangentMat.entries[1] = bitangent.x;
	tangentMat.entries[2] = normal.x;

	//Second row
	tangentMat.entries[4] = tangent.y;
	tangentMat.entries[5] = bitangent.y;
	tangentMat.entries[6] = normal.y;

	//third row
	tangentMat.entries[8] = tangent.z;
	tangentMat.entries[9] = bitangent.z;
	tangentMat.entries[10] = normal.z;

	//fourth row
	tangentMat.entries[15] = 1.0;

	tangentMat.Transpose();
	return tangentMat;
}
